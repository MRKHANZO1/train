...
if (isset($_GET['error'])) {
    echo "<script>alert('Payment successfull'); window.location = 'individual.php?page=reg';</script>";
    exit;
}
?>
<!DOCTYPE html>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar  navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav" >
                ...
                <li class="navbar-nav">
                    <a class="nav-link" href="#" style="background-color: #333; color:azure;">BAKAAL EXPRESS
                </li>
            </ul>
        ...
        <div class="content-wrapper" style="background-color: #333;">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark" style="color: white ;"> Passenger's Dashboard</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
