...
<body class="hold-transition sidebar-mini" style="background-color: #333">
    <div class="wrapper">
        ...
        <nav class="main-header navbar  navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="navbar-nav">
                    <a class="nav-link" href="#" style="background-color: #333; color:azure;">BAKAAL EXPRESS</a>
        ...
        <div class="content-wrapper" style="background-color: #333; color:white;">
            <!-- Content Header (Page header) -->
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark" style=" color:white;"> Administrator Dashboard</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong><?php echo date("Y"); ?> - AbdiKhan</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
